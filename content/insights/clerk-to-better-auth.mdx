...
<Stat value="5h" label="深夜ワンショットで Clerk → Better Auth 全面移行" source="mixednuts 2026-04-22 実施" />
...
A. 2025/9 の v1 安定版リリース後、本番投入事例が増加しています。<Cite n={2}>Auth.js v5</Cite> の公式後継として Auth.js コアチームが支持している点も大きい。ただし Clerk のような 24/7 サポートは期待できないので、認証障害時に自力で調査できる DevOps スキルは必要。
...
**Clerk 関連の既知挙動:**
- [<Cite n={1}>Clerk issue #2595</Cite>: `after_sign_in_url` ignored on existing session](https://github.com/clerk/javascript/issues/2595) — 本記事で言及した既知バグ
- [Clerk Development Instances docs](https://clerk.com/docs/deployments/overview#development-instances) — dev instance の本番挙動制約

**<Cite n={3}>Neon Postgres</Cite>:**
