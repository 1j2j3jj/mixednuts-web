...
<Stat value="24/7" label="PC 電源不要で定期ジョブを走らせる v6 アーキテクチャ" source="mixednuts 2026-04 移行" />
...
**<Cite n={1}>Claude Code Routines</Cite>:**
- [Claude Code Routines](https://docs.claude.com/en/docs/claude-code/routines) — 24/7 定期実行仕様
- [<Cite n={2}>Claude Max Plan</Cite>](https://www.anthropic.com/max) — Routines 含む $200/月
