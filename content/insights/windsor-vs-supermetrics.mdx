...
<Stat value="$23" label="/月 — Windsor.ai Basic の月額 (小〜中規模 EC 最適解)" source="Windsor.ai 公式 2026-04" />
...
**Q. 乗換コストは？**
A. BigQuery スキーマが Windsor 標準に合っているので、他社 SaaS からの移行は `INSERT INTO ... SELECT` ベースで可能。<Cite n={1}>Supermetrics</Cite> → Windsor は 1 日仕事。
...
**BigQuery 連携:**
- [<Cite n={3}>BigQuery Data Transfer Service</Cite>](https://cloud.google.com/bigquery/docs/dts-introduction) — Google 公式
