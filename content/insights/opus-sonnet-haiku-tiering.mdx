...
<Stat value="$165" label="/月 — 123 体組織の月間トークンコスト (Max Plan $200 内)" source="mixednuts 2026-04 実測" />
...
**Claude モデル公式:**
- [<Cite n={1}>Claude Models Overview</Cite>](https://docs.claude.com/en/docs/about-claude/models) — Opus / Sonnet / Haiku の比較
...
- [<Cite n={2}>Claude Max Plan</Cite>](https://www.anthropic.com/max) — $200/月
