...
export default function PrivacyPage() {
  return (
    <>
      {/* Legal-specific element styling, scoped under .prose, matched to the v4 light palette */}
      <style>{`
        .mn-v4 .prose .toc { background: #F7F8FA; border: 1px solid #E5E7EB; border-radius: 14px; padding: 30px 32px; margin-bottom: 18px; }
        .mn-v4 .prose .toc h3 { font-family: var(--font-sans-en); font-size: 11px; color: #9CA3AF; letter-spacing: 0.2em; text-transform: uppercase; font-weight: 700; margin: 0 0 16px; }
        .mn-v4 .prose .toc ol { list-style: none; counter-reset: toc; padding: 0; margin: 0; }
        .mn-v4 .prose .toc ol li { counter-increment: toc; padding: 6px 0; padding-left: 0; font-size: 14px; line-height: 1.7; }
        .mn-v4 .prose .toc ol li::before { content: counter(toc, decimal-leading-zero) " — "; position: static; width: auto; height: auto; background: none; color: var(--cyan-deep, #00B4D8); font-weight: 700; }
        .mn-v4 .prose .toc ol li a { color: #0A0A0A; text-decoration: none; transition: color 0.2s; }
        .mn-v4 .prose .toc ol li a:hover { color: var(--cyan-deep, #00B4D8); }
        .mn-v4 .prose h2[id] { scroll-margin-top: 100px; }
        .mn-v4 .prose h3 { font-family: var(--font-serif-jp); font-size: 19px; font-weight: 700; color: #0A0A0A; margin-top: 10px; line-height: 1.5; }
        .mn-v4 .prose ol.numbered { counter-reset: num; padding: 0; margin: 0; }
        .mn-v4 .prose ol.numbered li { list-style: none; counter-increment: num; position: relative; padding-left: 36px; font-size: 16px; line-height: 1.9; color: #26272B; margin-bottom: 13px; }
        .mn-v4 .prose ol.numbered li::before { content: counter(num); position: absolute; left: 0; top: 0; width: auto; height: auto; background: none; font-family: var(--font-sans-en); font-weight: 700; font-size: 13px; color: var(--cyan-deep, #00B4D8); }
        .mn-v4 .prose .info-box { background: #F7F8FA; border: 1px solid #E5E7EB; border-radius: 8px; padding: 22px 26px; font-size: 15px; line-height: 1.95; color: #26272B; }
        .mn-v4 .prose .info-box strong { color: #0A0A0A; }
        .mn-v4 .prose .info-box a { color: #0A0A0A; text-decoration: underline; }
        .mn-v4 .prose table { width: 100%; border-collapse: collapse; border: 1px solid #E5E7EB; border-radius: 10px; overflow: hidden; font-size: 14px; }
        .mn-v4 .prose table th, .mn-v4 .prose table td { padding: 14px 16px; border: 1px solid #E5E7EB; text-align: left; line-height: 1.7; color: #26272B; }
        .mn-v4 .prose table th { background: #F7F8FA; color: #0A0A0A; font-weight: 700; }
        .mn-v4 .prose table a { color: var(--cyan-deep, #00B4D8); text-decoration: underline; }
        .mn-v4 .prose .priv-end { text-align: right; margin-top: 48px; font-size: 13px; color: #9CA3AF; }
      `}</style>
      ...
      <header className="subhero">
        ...
        <div className="wrap subhero-inner">
          ...
          <h1 className="big-title-jp reveal" style={{ fontSize: "clamp(30px,4vw,50px)" }}>
            プライバシーポリシー
          </h1>
          ...
          <div className="subhero-meta reveal">
            <div>
              <div className="k">2021.04.19</div>
              <div className="l">制定日</div>
            </div>
            <div>
              <div className="k">2026.04.17</div>
              <div className="l">最終改定日</div>
            </div>
            <div>
              <div className="k">v3.0</div>
              <div className="l">版</div>
            </div>
          </div>
        </div>
      </header>
      ...
      <article className="prose">
        ...
        <div className="info-box reveal">
          ...
          Email: <a href="mailto:privacy@mixednuts-inc.com">privacy@mixednuts-inc.com</a><br />
