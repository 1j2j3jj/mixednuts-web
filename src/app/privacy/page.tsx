        ...
        <div className="legal-body-inner">
          <div className="toc">
            ...
            <ol>
              ...
              <li>
                <a href="#sec2">収集する個人情報</a>
              </li>
              <li>
                <a href="#sec3">利用目的</a>
              </li>
              <li>
                <a href="#sec4">第三者への提供</a>
              </li>
              <li>
                <a href="#sec5">個人情報の委託</a>（
                <a href="#sec5b">5-2. 外国にある第三者への提供</a> /{" "}
                <a href="#sec5c">5-3. 採用応募情報</a> /{" "}
                <a href="#sec5d">5-4. クライアント向けダッシュボード</a>）
              </li>
              <li>
                <a href="#sec6">安全管理措置</a>
              </li>
              <li>
                <a href="#sec7">クッキー（Cookie）の使用</a>
              </li>
              <li>
                <a href="#sec8">AI ツール利用時の取扱い</a>
              </li>
              <li>
                <a href="#sec9">個人情報に関するお問い合わせ</a>
              </li>
              <li>
                <a href="#sec10">プライバシーポリシーの変更</a>
              </li>
            </ol>
          </div>
          ...
          <p>
            本プライバシーポリシーにおける「個人情報」とは、個人情報の保護に関する法律に規定する「個人情報」を意味し、生存する個人に関する情報であって、当該情報に含まれる氏名、生年月日、住所、電話番号、メールアドレスその他の記述等により特定の個人を識別できる情報および個人識別符号が含まれる情報を指します。
          </p>
          ...
          <ul>
            <li>
              当社ウェブサイトのお問い合わせフォームをご利用いただいた場合
            </li>
            <li>当社のサービス・コンサルティング契約を締結した場合</li>
            <li>
              当社が提供するクライアント向けダッシュボードに招待・登録された場合
            </li>
            <li>
              当社主催のセミナー、ウェビナー、イベントにお申し込みいただいた場合
            </li>
          ...
          <p>
            収集する情報は、お名前・会社名・役職・メールアドレス・電話番号・ご相談内容・応募書類等です。
          </p>
          ...
          <p>
            当社は、上記の目的を超えて個人情報を利用する場合、事前にご本人の同意を得ます。
          </p>

          <h2 id="sec4">4. 第三者への提供</h2>
          <p>
            当社は、以下の場合を除き、ご本人の同意なしに個人情報を第三者に提供しません。
          </p>
          <ul>
            <li>法令に基づく場合</li>
          ...
          <p>
            当社は、利用目的の達成に必要な範囲で、個人情報の取扱いを第三者に委託することがあります。主な委託先は以下の通りです。
          </p>
          <ul>
            <li>
              クラウドサービス事業者（Google Workspace, AWS, Cloudflare, Vercel
              Inc., Neon Inc., Web3Forms 等）
            </li>
            <li>
              会計・税務処理を目的とした税理士事務所・会計システム提供事業者
            </li>
            <li>請求・決済代行事業者</li>
            <li>カスタマーサポートシステム提供事業者</li>
          </ul>
          <p>
            当社は、委託先との間で個人情報の取扱いに関する契約を締結し、適切な監督を実施します。
          </p>

          <h2 id="sec5b">5-2. 外国にある第三者への個人情報の提供</h2>
          <p>
            当社は、サービス提供のため以下の外国にある第三者（クラウドサービス事業者）に個人情報の取扱いを委託します。本ウェブサイトのフォームをご利用いただくことで、これらの委託に同意いただいたものとみなします。
          </p>
          <table>
            <thead>
              <tr>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ウェブサイトホスティング、Edge
                  Functions、クライアント向けダッシュボードのホスティング
                </td>
              </tr>
              <tr>
                <td>Neon Inc. (AWS us-east-1)</td>
                <td>米国</td>
                <td>
                  認証データベース（クライアント向けダッシュボードのアカウント情報を含む）
                </td>
              </tr>
              <tr>
                <td>Web3Forms</td>
                <td>米国</td>
                <td>お問い合わせ・採用応募の通知配信</td>
              </tr>
              <tr>
                <td>Google LLC</td>
                <td>米国</td>
                <td>
                  採用応募ファイル保存（Google Drive）、Google
                  Workspace、クライアント向けダッシュボードのログイン認証（Google
                  OAuth）
                </td>
              </tr>
              <tr>
                ...
                <td>米国</td>
                <td>クライアント向けダッシュボードの招待メール配信</td>
              </tr>
            </tbody>
          </table>
          <p>
            各国の個人情報保護制度に関する情報は、個人情報保護委員会のウェブサイト（
            <a
            ...
            ）にて確認できます。米国は十分性認定国ではないため、当社は個人情報保護委員会規則第
            16 条に基づく相当措置（標準契約条項または GDPR
            同等の保護水準の確認）を実施します。
          </p>

          <h2 id="sec5c">5-3. 採用応募情報の取扱い</h2>
          <p>
            採用応募フォームから取得する個人情報（氏名、連絡先、職務経歴書、履歴書等）は、採用選考の目的のみに使用します。
          </p>
          <ul>
            <li>
              <strong>保存場所</strong>: Google Drive（米国 Google LLC が運営）
            </li>
            <li>
              <strong>アクセス権限</strong>: 採用担当者および代表者のみ
            </li>
            <li>
              <strong>保存期間</strong>: 不採用の場合、応募受付から 6
              ヶ月経過後に削除します。採用の場合は雇用契約継続中保管します
            </li>
            <li>
              <strong>第三者提供</strong>:
          ...
          <h2 id="sec5d">
            5-4. クライアント向けダッシュボードにおける個人情報の取扱い
          </h2>
          <p>
            当社は、コンサルティングサービスの一環として、クライアント企業向けの
            BI
            ダッシュボード（以下「本ダッシュボード」）を提供しています。本ダッシュボードの利用に関する個人情報の取扱いは、本条の定めによります。
          </p>

          <h3>(1) 取得する情報と取得の方法</h3>
          <p>
            当社は、本ダッシュボードの利用にあたり、以下の情報を取得します。
          </p>
          <ul>
            <li>
              <strong>アカウント情報</strong>:
              氏名、メールアドレス（クライアント企業の管理者からの招待、または
              Google アカウントによるログイン時に取得します）
            </li>
            <li>
              <strong>利用記録</strong>:
              ログイン日時、閲覧・操作の記録（監査ログとして取得します）
            </li>
          </ul>
          <p>
            本ダッシュボードは招待制であり、クライアント企業との契約に基づき、当社またはクライアント企業の管理者が招待したご本人のみが利用できます。
          </p>
          ...
          <p>
            上記の目的を超えて利用する場合は、事前にご本人の同意を得ます。取得した個人情報を広告配信・マーケティング目的で利用することはありません。
          </p>

          <h3>(3) 表示するデータについて</h3>
          <p>
            本ダッシュボードは、クライアント企業から預託を受けた広告運用データ（Google
            広告・Meta 広告等）、アクセス解析データ（Google
            アナリティクス）、売上データを、当社が管理する Google Cloud
            BigQuery（東京リージョン）に集約し、集計値として表示するものです。これらのデータはクライアント企業の事業データであり、当該クライアント企業との業務委託契約および秘密保持契約に基づいて取り扱います。
          </p>
          ...
          <table>
            ...
            <tbody>
              <tr>
                <td>アカウント情報（氏名・メールアドレス・招待記録）</td>
                <td>Neon Inc. が運営するデータベース（米国）</td>
                <td>
                  アカウント削除まで。削除の申出を受けた場合、または退会手続が行われた場合、遅滞なく削除します
                </td>
              </tr>
              <tr>
                <td>監査ログ</td>
                <td>同上</td>
                <td>
                  取得から原則 1 年間（不正アクセス調査等で必要な場合を除く）
                </td>
              </tr>
              <tr>
                <td>集計対象のクライアント事業データ</td>
                <td>Google Cloud BigQuery（東京リージョン）</td>
                <td>
                  クライアント企業との契約終了後、契約に定める期間内に削除します
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <h3>(5) 第三者提供・委託</h3>
          <p>
            当社は、法令に基づく場合を除き、本ダッシュボードで取得した個人情報を第三者に提供しません。あるクライアント企業のユーザー情報・事業データを、他のクライアント企業が閲覧することはできません（アクセス権限により論理的に分離しています）。
          </p>
          <p>
            システムの運用にあたり、以下の事業者に個人情報の取扱いを委託します（外国にある第三者への委託を含みます。詳細は第
            5-2
            条の表をご参照ください）。当社は各委託先との間でデータ処理に関する契約（DPA
            等）を確認・締結し、委託先を適切に監督します。
          </p>
          <ul>
            <li>Vercel Inc.（米国）— アプリケーションのホスティング</li>
            <li>Neon Inc.（米国）— 認証・アカウントデータベース</li>
            <li>
              Google LLC / Google Cloud（データ保存は東京リージョン）—
              事業データの集計基盤（BigQuery）、Google
              アカウントによるログイン認証（Google OAuth）
            </li>
            <li>
              Resend（Plus Five Five, Inc.、米国）— 招待メール等の配信（送信元:
              dashboard@mixednuts-inc.com）
            </li>
          </ul>

          <h3>(6) ご本人の権利（開示・訂正・削除等）</h3>
          <p>
            ご本人は、当社に対し、ご自身の個人情報について以下を請求できます。手続・手数料（無料）・回答期限は第
            9 条の定めに従います。
          </p>
          <ul>
            <li>
              利用目的の通知、保有個人データの開示（個人情報保護法第 32 条・第
              33 条）
            </li>
          ...
          <p>
            アカウントの削除（退会）をご希望の場合は、所属するクライアント企業の管理者、または下記窓口までお申し出ください。削除の申出を受けた場合、認証データベース上のアカウント情報を遅滞なく削除します。なお、法令上保存が必要な記録（監査ログ等）は、当該保存義務の範囲でのみ保持します。
          </p>

          <h3>(7) 管理者（事業者）情報・お問い合わせ窓口</h3>
          <div className="info-box">
            <strong>事業者</strong>:
            ミックスナッツ株式会社（東京都港区南青山3-8-40）
            <br />
            <strong>本ダッシュボードに関するお問い合わせ</strong>:{" "}
            <a
              href="mailto:info@mixednuts-inc.com"
            ...
            <a
              href="mailto:privacy@mixednuts-inc.com"
              style={{ color: "var(--navy)", textDecoration: "underline" }}
            >
              privacy@mixednuts-inc.com
            </a>
            （第 9 条の窓口）
          </div>
          <p>
            EU 域内から本ダッシュボードを利用する場合、上記の事業者が GDPR
            上の管理者（Controller）に相当します。取扱いの法的根拠は、契約の履行（アカウント管理・認証）および正当な利益（不正アクセス防止のための監査ログ）です。ご本人にはアクセス権・訂正権・消去権・処理制限権・データポータビリティ権・異議申立権があり、監督機関へ苦情を申し立てる権利を有します。
          </p>

          <h2 id="sec6">6. 安全管理措置</h2>
          <p>
            当社は、個人情報の漏洩、滅失、毀損の防止その他の安全管理のために、組織的・人的・物理的・技術的な安全管理措置を講じます。
          </p>
          <h3>組織的安全管理措置</h3>
          <ul>
          ...
          <ul>
            ...
            <li>
              個人情報保護および情報セキュリティに関する定期的な研修の実施
            </li>
          </ul>
          <h3>物理的安全管理措置</h3>
          <ul>
          ...
          <ul>
            <li>
              個人情報へのアクセス制御（アクセス権限の付与を業務上必要な範囲に限定）
            </li>
          ...
          <p>
            当社ウェブサイトでは、サービス向上のためクッキー（Cookie）を使用しています。
          </p>
          <table>
            <thead>
              <tr>
            ...
            <tbody>
              <tr>
                <td>必須</td>
                <td>ウェブサイトの基本機能</td>
                <td>不可（ブラウザ設定で無効化可能）</td>
              </tr>
              <tr>
                <td>分析</td>
                <td>Google Analytics によるアクセス解析</td>
                <td>ブラウザ設定またはオプトアウトツール</td>
              </tr>
              <tr>
                <td>広告</td>
                <td>Google Ads / Meta Pixel によるリターゲティング</td>
                <td>各プラットフォームのオプトアウトツール</td>
              </tr>
            </tbody>
          </table>
          ...
          <div className="info-box">
            <strong>当社の AI 利用ポリシー:</strong>{" "}
            当社は自社業務およびクライアント支援業務において、Claude
            (Anthropic)、ChatGPT (OpenAI)、Gemini (Google)
            等の大規模言語モデルを活用しています。
          </div>
          <ul>
            <li>
              お客様の機密情報を AI
              ツールに入力する際は、学習に利用されない契約プラン（Enterprise
              契約等）を選択します
            </li>
            <li>
              個人を特定できる情報は、匿名化・仮名化してから AI に渡します
            </li>
            <li>
              AI
              の出力結果は人間が必ずレビュー・検証してから成果物として利用します
            </li>
            <li>
              クライアント契約時に NDA を締結し、AI
              利用時のデータ取扱いについても明確化します
            </li>
          </ul>

          <h2 id="sec9">9. 個人情報に関するお問い合わせ・開示請求</h2>
          <p>
            ご自身の個人情報の開示・訂正・追加・削除・利用停止・第三者提供記録の開示等をご希望の場合、または本プライバシーポリシーに関するご質問がある場合は、以下の窓口までご連絡ください。
          </p>
          <div className="info-box">
          ...
          <ul>
            <li>
              ...
              ご本人様であることを確認するため、運転免許証・健康保険証・パスポート等の本人確認書類の写しの提示をお願いします（マスキング推奨）。代理人による請求の場合は、代理権を証明する書類（委任状）も併せてご提示ください。
            </li>
            <li>
              <strong>手数料</strong>: 個人情報の開示請求にかかる手数料は
              <strong>無料</strong>です（個人情報保護法第 38 条）。
            </li>
            <li>
              <strong>回答期限</strong>: ご請求受領後、原則として 14
              日以内に対応します。本人確認・調査に時間を要する場合は、別途ご連絡します。
            </li>
            <li>
              <strong>回答方法</strong>:
              メールまたは郵送にて回答します。請求時にご希望の方法をお知らせください。
            </li>
          </ul>

          <h2 id="sec10">10. プライバシーポリシーの変更</h2>
          <p>
            当社は、必要に応じて本プライバシーポリシーを変更することがあります。変更した場合は、当社ウェブサイト上で公表します。
          </p>
